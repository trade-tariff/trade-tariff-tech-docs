...
- [Sentry Organization Stats](https://sentry.io/organizations/engine-le/stats/)
  for an overview of how many errors are being sent/rate-limited site-wide.
- [Sentry Projects](https://sentry.io/organizations/engine-le/projects/)
  for a per-project view, enabling you to see which ones are causing the
  most errors right now.

[Sentry]: https://sentry.io/engine-le/

## Getting access to Sentry

Your tech lead should raise a PR to give you Sentry access in the [govuk_tech.yml file in govuk-user-reviewer](https://github.com/trade-tariff/govuk-user-reviewer/blob/main/config/govuk_tech.yml). Once the PR is merged and the Terraform has been applied, you'll be able to [sign in](https://sentry.io/auth/login/) using your GDS Google account.
...
- **Project**: each GOV.UK application has its own project on Sentry, where
  ...
  [publishing-api](https://sentry.io/organizations/engine-le/issues/?project=5738286)
...
[example-issue]: https://sentry.io/organizations/engine-le/issues/2150349125/?project=202259&query=is%3Aunresolved
[example-error]: https://sentry.io/organizations/engine-le/issues/2155210524/events/aa4edd05a94c4d14b07d4c754a13c788/
...
[Teams are managed in govuk-user-reviewer](https://github.com/trade-tariff/govuk-user-reviewer/blob/main/terraform/saas/sentry.tf),
and [projects are managed in govuk-infrastructure](https://github.com/trade-tariff/govuk-infrastructure/blob/main/terraform/deployments/sentry/locals.tf).
...
[delegator-pattern]: https://github.com/trade-tariff/govuk_app_config/pull/160
[sentry-ruby]: https://github.com/getsentry/sentry-ruby/tree/master/sentry-raven
[govuk_app_config]: https://github.com/trade-tariff/govuk_app_config
[govukerror]: https://github.com/trade-tariff/govuk_app_config/blob/master/lib/govuk_app_config/govuk_error.rb
[email-alert-api-example]: https://github.com/trade-tariff/email-alert-api/blob/main/config/initializers/govuk_error.rb
[manually-report]: https://github.com/trade-tariff/govuk_app_config/blob/073c9b2312a4893b040c9225b713ac880c69f5b8/README.md#manual-error-reporting
...
[govuk_app_config-excluded_exceptions]: https://github.com/trade-tariff/govuk_app_config/blob/b911c5bbef9bd1df6a92cf31eb5a8e0d3a91d851/lib/govuk_app_config/govuk_error/configure.rb#L20-L50
[data_sync_excluded_exceptions]: https://github.com/trade-tariff/govuk_app_config/blob/b911c5bbef9bd1df6a92cf31eb5a8e0d3a91d851/lib/govuk_app_config/govuk_error/configure.rb#L57-L65
...
[datasync-chain-inspection]: https://github.com/trade-tariff/govuk_app_config/blob/b911c5bbef9bd1df6a92cf31eb5a8e0d3a91d851/lib/govuk_app_config/govuk_error/configuration.rb#L43
...
[error-reporting]: https://github.com/trade-tariff/govuk_app_config/blob/master/README.md#error-reporting
[combined-code]: https://github.com/trade-tariff/govuk_app_config/blob/589b7aae49c3584ead2f60f915be05a7922c5c3e/lib/govuk_app_config/govuk_error/configuration.rb#L63–L71
...
[sentry-configure-rate-limits]: https://sentry.io/settings/engine-le/rate-limits/
...
[Alerts panel]: https://sentry.io/organizations/engine-le/alerts/rules/

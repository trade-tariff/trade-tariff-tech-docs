RSpec.describe Snippet do
  describe ".generate" do
    it "generates a proper snippet without the opsmanual warning" do
      html = <<~HTML
        <blockquote>
        <p><strong>This page was imported from <a href="https://github.com/trade-tariff/govuk-legacy-opsmanual">the opsmanual on GitHub Enterprise</a></strong>.
        It hasn&rsquo;t been reviewed for accuracy yet.
        <a href="https://github.com/trade-tariff/govuk-legacy-opsmanual/tree/master/2nd-line/howto-manually-remove-assets.md">View history in old opsmanual</a></p>
        </blockquote>
